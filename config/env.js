...
const env = {
  ...
  IMAGE_PROCESSING_SERVICE_BASE_ADDRS: process.env.IMAGE_PROCESSSING_SERVICE_BASE_ADDRS,
  IMAGE_PROCESSING_SERVICE_PORT: process.env.IMAGE_PROCESSSING_SERVICE_PORT,

  // data-managment-service props
  DATA_MANAGEMENT_SERVICE_BASE_ADDRS:
    process.env.DATA_MANAGMENT_SERVICE_BASE_ADDRS,
  ...
  PREDICTION_SERVICE_PORT: process.env.PREDICTION_SERVICE_PORT,
};
